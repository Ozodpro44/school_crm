// Package middleware provides JWT authentication for teacher_service.
//
...
// and it handles teacher accounts (including login-capable credentials) and
// salary data — without its own check, anyone who can reach the service
// directly bypasses authentication entirely.
package middleware
