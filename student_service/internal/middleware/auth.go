// Package middleware provides JWT authentication for student_service.
//
...
// and its branch_id scoping (see handler.requestBranchID) depends on
// X-User-Branch-ID actually being set by a verified JWT rather than a
// client-supplied header — without this middleware, a caller reaching the
// service directly could forge that header and read/modify any branch's
// students, classes, attendance, or assignments.
package middleware
