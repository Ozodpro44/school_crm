...
// 		tables, err := fetchDatabaseTables(database.Conn)
// 		if err != nil {
...
// 		migrations, err := fetchDatabaseMigrations(database.Conn)
// 		if err != nil {
...
// 		studentCount, err := generateTestStudents(ctx, database.Conn, branch)
// 		if err != nil {
...
// 		teacherCount, err := generateTestTeachers(ctx, database.Conn, branch)
// 		if err != nil {
...
// 		classCount, err := generateTestClasses(ctx, database.Conn, branch)
// 		if err != nil {
...
// 		paymentCount, err := generateTestPayments(ctx, database.Conn, branch)
// 		if err != nil {
...
// func generateTestStudents(ctx interface{}, conn *sql.DB, branchID string) (int, error) {
// 	testNames := []string{
...
// func generateTestTeachers(ctx interface{}, conn *sql.DB, branchID string) (int, error) {
// 	testTeachers := []string{
...
// func generateTestClasses(ctx interface{}, conn *sql.DB, branchID string) (int, error) {
// 	testClasses := []string{
...
// func generateTestPayments(ctx interface{}, conn *sql.DB, branchID string) (int, error) {
