// Package middleware provides JWT authentication for finance_service.
//
...
// and it handles financial data (expenses, budgets) — without its own
// check, anyone who can reach the service directly bypasses authentication
// entirely.
package middleware
