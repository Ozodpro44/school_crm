...
CREATE OR REPLACE VIEW "user".settings     AS SELECT * FROM public.settings;
...
GRANT USAGE  ON SCHEMA "user"             TO school_user;
GRANT SELECT ON ALL TABLES IN SCHEMA "user" TO school_user;
...
CREATE OR REPLACE VIEW student.student_notes         AS SELECT * FROM public.student_notes;
...
GRANT USAGE  ON SCHEMA student               TO school_user;
GRANT SELECT ON ALL TABLES IN SCHEMA student TO school_user;
