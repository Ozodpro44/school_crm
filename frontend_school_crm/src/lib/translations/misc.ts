...
export const miscTranslations: Partial<Translation> = {
  ...
  totalEnrolled: { "uz-cyrl": "жами ўлшов", "uz-latn": "jami o'lshov", en: "total enrolled" },
  ...
  pendingExpenses: { "uz-cyrl": "Ўтқазиб юборилган харажатлар", "uz-latn": "O'tkázib yuborilgan xarajatlar", en: "Pending Expenses" },
  studentDebtors: { "uz-cyrl": "Ўқувчи қарздорлари", "uz-latn": "O'quvchi qarzdorlari", en: "Student Debtors" },
  studentsWithUnpaidFees: { "uz-cyrl": "Тўланмаган туй қўшилган ўқувчилар", "uz-latn": "To'lanmagan tuy qo'shilgan o'quvchilar", en: "Students with unpaid fees" },
  unpaidSalaries: { "uz-cyrl": "Тўланмаган маиш", "uz-latn": "To'lanmagan maish", en: "Unpaid Salaries" },
  teacherSalaryPaymentsDue: { "uz-cyrl": "ўқитувчи маищ тўловлари қўшилиб қолди", "uz-latn": "o'qituvchi maish to'lovlari qo'shilib qoldi", en: "teacher salary payments due" },
  ...
  quickStatsSummary: { "uz-cyrl": "Тез статистика ҳулоса", "uz-latn": "Tez statistika xulosа", en: "Quick Stats Summary" },
  welcomeToSchoolManagement: { "uz-cyrl": "мактаб бошқаруви тизимига хуш келибсиз", "uz-latn": "maktab boshqaruvi tizimiга хуш kelibsiz", en: "welcome to school management system" },
  ...
  fieldRequired: { "uz-cyrl": "Бу майдон мажбурий", "uz-latn": "Bu maydon majburiy", en: "This field is required" },
